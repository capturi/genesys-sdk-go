...
func (o *Mediaiceselectedpair) SetField(field string, fieldValue interface{}) {
...
func (o Mediaiceselectedpair) MarshalJSON() ([]byte, error) {
...
func (o *Mediaiceselectedpair) UnmarshalJSON(b []byte) error {
	var MediaiceselectedpairMap map[string]interface{}
	err := json.Unmarshal(b, &MediaiceselectedpairMap)
	if err != nil {
		return err
	}
