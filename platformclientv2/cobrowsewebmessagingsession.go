...
type Cobrowsewebmessagingsession struct {
	...
	DateOfferEnds *time.Time `json:"dateOfferEnds,omitempty"`

	// CommunicationType - CommunicationType for Cobrowse Session
...
func (o *Cobrowsewebmessagingsession) SetField(field string, fieldValue interface{}) {
...
func (o Cobrowsewebmessagingsession) MarshalJSON() ([]byte, error) {
...
func (o *Cobrowsewebmessagingsession) UnmarshalJSON(b []byte) error {
	var CobrowsewebmessagingsessionMap map[string]interface{}
	err := json.Unmarshal(b, &CobrowsewebmessagingsessionMap)
	if err != nil {
		return err
	}
