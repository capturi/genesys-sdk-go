...
// DeleteUserVerifier invokes DELETE /api/v2/users/{userId}/verifiers/{verifierId}
//
// Delete a verifier
func (a UsersApi) DeleteUserVerifier(userId string, verifierId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/{userId}/verifiers/{verifierId}"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	path = strings.Replace(path, "{verifierId}", url.PathEscape(fmt.Sprintf("%v", verifierId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &userId == nil {
		// false
		return nil, errors.New("Missing required parameter 'userId' when calling UsersApi->DeleteUserVerifier")
	}
	// verify the required parameter 'verifierId' is set
	if &verifierId == nil {
		// false
		return nil, errors.New("Missing required parameter 'verifierId' when calling UsersApi->DeleteUserVerifier")
	}
...
func (a UsersApi) GetAnalyticsUsersAggregatesJob(jobId string) (*Asyncquerystatus, *APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling UsersApi->GetAnalyticsUsersAggregatesJob")
	}
...
func (a UsersApi) GetAnalyticsUsersAggregatesJobResults(jobId string, cursor string) (*Userasyncaggregatequeryresponse, *APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling UsersApi->GetAnalyticsUsersAggregatesJobResults")
	}
...
// GetUserSkillgroups invokes GET /api/v2/users/{userId}/skillgroups
//
// Get skill groups for a user
func (a UsersApi) GetUserSkillgroups(userId string, pageSize int, after string, before string) (*Userskillgroupentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->GetUserSkillgroups")
	}
	...
	var successPayload *Userskillgroupentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes)
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Userskillgroupentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetUserVerifiers invokes GET /api/v2/users/{userId}/verifiers
//
// Get a list of verifiers
func (a UsersApi) GetUserVerifiers(userId string) (*Verifierentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/{userId}/verifiers"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	defaultReturn := new(Verifierentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->GetUserVerifiers")
	}
	...
	var successPayload *Verifierentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes)
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Verifierentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a UsersApi) GetUsersDevelopmentActivity(activityId string, varType string) (*Developmentactivity, *APIResponse, error) {
	...
	path = strings.Replace(path, "{activityId}", url.PathEscape(fmt.Sprintf("%v", activityId)), -1)
...
func (a UsersApi) PostAnalyticsUsersActivityQuery(body Useractivityquery, pageSize int, pageNumber int) (*Useractivityresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PostAnalyticsUsersActivityQuery")
	}
...
func (a UsersApi) PostAnalyticsUsersAggregatesJobs(body Userasyncaggregationquery) (*Asyncqueryresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PostAnalyticsUsersAggregatesJobs")
	}
...
// PostUsersSearchConversationTarget invokes POST /api/v2/users/search/conversation/target
//
...
func (a UsersApi) PostUsersSearchConversationTarget(body Usersearchrequest) (*Userssearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/search/conversation/target"
	defaultReturn := new(Userssearchresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PostUsersSearchConversationTarget")
	}
...
// PostUsersSearchQueuemembersManage invokes POST /api/v2/users/search/queuemembers/manage
//
...
func (a UsersApi) PostUsersSearchQueuemembersManage(body Usersearchrequest) (*Userssearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/search/queuemembers/manage"
	defaultReturn := new(Userssearchresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PostUsersSearchQueuemembersManage")
	}
...
// PutUserVerifier invokes PUT /api/v2/users/{userId}/verifiers/{verifierId}
//
// Update a verifier
func (a UsersApi) PutUserVerifier(userId string, verifierId string, body Updateverifierrequest) (*Verifier, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/{userId}/verifiers/{verifierId}"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	path = strings.Replace(path, "{verifierId}", url.PathEscape(fmt.Sprintf("%v", verifierId)), -1)
	defaultReturn := new(Verifier)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->PutUserVerifier")
	}
	// verify the required parameter 'verifierId' is set
	if &verifierId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'verifierId' when calling UsersApi->PutUserVerifier")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PutUserVerifier")
	}
