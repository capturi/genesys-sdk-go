...
type Knowledgedocumentfeedbackresponse struct {
	...
	// User - The user who created the feedback.
...
func (o *Knowledgedocumentfeedbackresponse) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgedocumentfeedbackresponse) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgedocumentfeedbackresponse) UnmarshalJSON(b []byte) error {
	var KnowledgedocumentfeedbackresponseMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgedocumentfeedbackresponseMap)
	if err != nil {
		return err
	}
